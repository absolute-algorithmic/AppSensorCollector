App inspired by the library [AndroidSensorCollector](https://jitpack.io/#ignassew/AndroidSensorCollector) - [Github](https://github.com/ignassew/AndroidSensorCollector)
